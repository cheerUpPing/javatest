    ...
    jQuery.extend({
        initLoginForm: function () {
            b = $("#loginForm").validate({
                ...
                onkeyup: false,
                rules: {
                    "loginUserDTO.user_name": {requiredUserName: true, checkLoginUserName: true},
                    "userDTO.password": {required: true, minlength: 6}
                },
                messages: {
                ...
                submitHandler: function (d) {
                    var e = dhtmlx.modalbox({targSrc: '<div style="z-index: 20000; position: fixed; left: 750.5px; top: 237px;"><img src="' + ctx + 'resources/images/loading.gif"></img></div>'});
                    $(d).ajaxSubmit({
            ...
            $("#loginSub").on("click", function (j) {
                ...
                var k = dhtmlx.modalbox({targSrc: '<div style="z-index: 20000; position: fixed; left: 750.5px; top: 237px;"><img src="' + ctx + 'resources/images/loading.gif"></img></div>'});

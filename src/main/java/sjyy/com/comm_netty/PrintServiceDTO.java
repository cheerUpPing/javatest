 ...
 * @version 1.0
 */
public class PrintServiceDTO implements Cloneable, Comparable<PrintServiceDTO> {
...
//    @Column
    ...
    @Override
    public int compareTo(PrintServiceDTO o) {
        return this.terminalNumber - o.terminalNumber > 0 ? 1 : 0;
    }

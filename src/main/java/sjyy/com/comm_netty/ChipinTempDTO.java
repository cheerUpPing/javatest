...
public class ChipinTempDTO {
    ...
    public String toString() {
        return "ChipinTempDTO{" +
                ...
                ", spValue='" + spValue + '\'' +
                ", isPrint=" + isPrint +
                ", isCountAward=" + isCountAward +
                ", awardBets=" + awardBets +
                ", tempAwardBets=" + tempAwardBets +
                ", tempInfo='" + tempInfo + '\'' +
                ", taxAwardBets=" + taxAwardBets +
                ", ticketId='" + ticketId + '\'' +
                ", strpassword='" + strpassword + '\'' +
                ", psdcheck='" + psdcheck + '\'' +
                ", blackmark='" + blackmark + '\'' +
                ", printservicenumber='" + printservicenumber + '\'' +
                ", postcount=" + postcount +
                ", printLaterTime=" + printLaterTime +
                ", ticketAward=" + ticketAward +
                ", awardPostCount=" + awardPostCount +
                ", awardservicenumber='" + awardservicenumber + '\'' +
                ", postTime=" + postTime +
                ", lastScreeningTime=" + lastScreeningTime +
                ", awardPostTime=" + awardPostTime +
                ", lotterytype='" + lotterytype + '\'' +
                ", exceptionInfo='" + exceptionInfo + '\'' +
                ", priorTicketAward=" + priorTicketAward +
                ", fromserialNo='" + fromserialNo + '\'' +
                ", priorPrint=" + priorPrint +
                ", awardPostStatus=" + awardPostStatus +
                ", testStatus=" + testStatus +
                ", schemenums='" + schemenums + '\'' +
                ", crypto='" + crypto + '\'' +
                ", TerminalType='" + TerminalType + '\'' +
                ", sellingISSUE='" + sellingISSUE + '\'' +
                '}';
    }
}
